...
define(
    ...
    function (require, declare, lang,ll,ts,svg) {
    	return{
    		setMultiLineTextSymbol:function(){
				...
				if( typeof dojox.gfx.svg.Text.prototype.setShape == 'function' )
				{
					dojox.gfx.svg.Text.prototype.setShape = function(p)
					{
						...
						{ 
							...
							var lineHeight = 1.3 * parseInt(document.defaultView.getComputedStyle(r, "").getPropertyValue("font-size"), 10); 
							...
							{ 
								...
								tspan.setAttribute("dy", i ? lineHeight : -2); 
